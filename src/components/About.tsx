  ...
  const features = [
    {
      ...
      description: "Localizada no bairro Velha em Blumenau-SC, região central com fácil acesso."
    },
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
              Por que escolher a
              <span className="text-primary block">Mecânica Milani?</span>
            </h2>
            ...
            <Card className="bg-gradient-hero text-white border-none shadow-elegant">
              <CardContent className="p-8">
                ...
                <div className="space-y-2 text-white/90">
                  ...
                  <p><strong>Finais de semana:</strong> Fechado</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card shadow-soft">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground text-lg mb-4">
                  Estamos localizados no bairro Velha, região central de Blumenau-SC.
                </p>
                <p className="text-sm text-muted-foreground mb-4">
                  📍 Rua Teresa Marta Mathes 35<br />
                  📍 Velha - Blumenau - SC<br />
                  📍 Fácil acesso
                </p>
                <div className="w-full h-64 sm:h-80 md:h-96 lg:h-[450px] rounded-lg overflow-hidden">
                  <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d889.2435009016615!2d-49.129733730379684!3d-26.936038602927397!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94df1be4f07f6849%3A0x67100a75365684e3!2sR.%20Teresa%20Marta%20Mathes%2C%2035%20-%20Velha%20Central%2C%20Blumenau%20-%20SC%2C%2089045-510!5e0!3m2!1spt-BR!2sbr!4v1755877994071!5m2!1spt-BR!2sbr" 
                    className="w-full h-full border-0"
                    allowFullScreen 
                    loading="lazy" 
                    referrerPolicy="no-referrer-when-downgrade"
                    title="Localização da Mecânica Milani em Blumenau"
                  />
                </div>
              </CardContent>
            </Card>
